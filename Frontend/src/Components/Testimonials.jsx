            ...
            <ul class="space-y-8">
              <li class="text-sm leading-6">
                <div class="relative group">
                  <div class="absolute transition rounded-lg opacity-25 -inset-1 bg-gradient-to-r from-red-600 to-red-900 blur duration-400 group-hover:opacity-100 group-hover:duration-200"></div>
                  <a
